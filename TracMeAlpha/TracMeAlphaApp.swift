...
@main
struct TracMeAlphaApp: App {
    @StateObject private var authManager: AuthManager
    private var developmentMode: Bool = false
    private var notificationCenter = NotificationCenter.default
    @State private var showingModal = false  // State for modal visibility
...
//        }
    ...
    var body: some Scene {
        WindowGroup {
            ...
            // Handle deep link callbacks for OAuth and registration flows
            .onOpenURL { url in
                handleDeepLink(url)
            }
        }
